...
Next, we can represent a group as an object with the exact same properties as the actual group's metadata. For instance:
...
- todo: Clarify the name collision paragraph a bit more? Especially the last sentence
